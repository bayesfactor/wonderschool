...
const TERMS = {
  ...
  /* ---- how a country's work is counted ---- */
  industry: ["Industry",
    "All the work of making physical things — factories, mines, building sites, power stations.",
    "About 23% of Japan's workers. The other three quarters are farming (under 3%) and services (about 74%)."],
  manufacturing: ["Manufacturing",
    "Making things in factories, specifically. A part of industry, but not all of it.",
    "10.3 million Japanese jobs, 15.1% of everyone working — and about 19% of everything Japan earns."],
  services: ["Services",
    "Work where nothing physical is produced: shops, hospitals, schools, banks, trains, restaurants.",
    "Three quarters of all Japanese jobs. The country most people picture as one enormous factory is mostly shops and hospitals."],
  "value-added": ["Value added",
    "What a business is worth to an economy: the value of what it sells, minus the cost of the materials it bought in.",
    "A bakery that buys ¥100 of flour and sells ¥400 of bread adds ¥300. Adding up sales instead would count the flour twice."],
  revenue: ["Revenue",
    "All the money a company takes in from selling things, before any costs are paid.",
    "Not profit. A trading house can move ¥100 billion of coal and keep almost none of it — huge revenue, thin earnings."],
  "market-cap": ["Market capitalisation",
    "What the stock market thinks a whole company is worth: the share price multiplied by the number of shares.",
    "It is an opinion, not a measurement, and it moves every day. Four different Japanese companies held the number-one spot during 2026 alone."],
  "sogo-shosha": ["Trading house (sōgō shōsha)",
    "A uniquely Japanese kind of company that buys, sells, ships and finances almost anything, anywhere.",
    "Mitsubishi Corporation is Japan's third-largest company by revenue with only 63,000 employees. Five of these giants handle a large share of Japan's raw-material imports."],
  "fortune-500": ["Fortune Global 500",
    "An annual list of the world's 500 largest companies by revenue.",
    "Japan had <strong>149</strong> companies on it in 1995. It has <strong>40</strong> now. No single statistic captures the last thirty years better."],
  export: ["Export",
    "Something made in one country and sold to another.",
    "Japan exported ¥110.4 trillion of goods in 2025. Motor vehicles alone were 16% of it."],
  "trade-surplus": ["Trade surplus and deficit",
    "A surplus means selling more abroad than you buy; a deficit is the reverse.",
    "Japan ran surpluses for decades. In 2025 it imported ¥113.3 trillion against ¥110.4 trillion of exports — a deficit of about ¥2.9 trillion."],

  /* ---- competition ---- */
  "market-share": ["Market share",
    "The slice of a whole world market that one company or one country holds.",
    "The number is only as good as the definition of the market. Toray has 13.5% of all carbon fibre but a far larger share of the aerospace grade — same company, same year, very different headline."],
  commodity: ["Commodity",
    "A product so standardised that one maker's version is interchangeable with another's, so the only thing left to compete on is price.",
    "Memory chips became a commodity. That is why Japan lost them: when every chip is the same, whoever builds the biggest factory fastest wins."],
  "robot-density": ["Robot density",
    "How many industrial robots a country has for every 10,000 factory workers.",
    "South Korea 1,220, Germany 449, Japan 446, the USA 307, China 166, world average 132. Japan <em>makes</em> the most robots but is not the most robotic."],
  "machine-tool": ["Machine tool",
    "A machine that makes machine parts — it cuts, grinds and shapes metal to a fraction of a millimetre.",
    "The ancestor of everything else in a factory. Japan led the world for 27 years, from 1982 until China passed it in 2009."],
  "cmos-sensor": ["Image sensor",
    "The chip inside a camera that turns light into numbers.",
    "Japanese firms make about 48% of them, Sony alone around 45%. There is a fair chance the camera you photograph this page with contains one."],
  semiconductor: ["Semiconductor",
    "A chip — the tiny patterned slice of silicon that does the thinking in every electronic thing.",
    "Japanese companies made close to half the world's chips in the late 1980s. Their share of global chip sales in 2024 was <strong>8.2%</strong>."],
  dram: ["DRAM",
    "The fast, forgetful memory a computer uses while it is switched on.",
    "Japan dominated it in the 1980s. Today Samsung and SK hynix, both Korean, hold 68% between them and no Japanese company makes it at all."],
  foundry: ["Foundry",
    "A factory that makes chips designed by other companies.",
    "Taiwan's TSMC is the biggest by far. Japan is paying it about ¥1.2 trillion to build two factories in Kumamoto."],
  nanometre: ["Nanometre",
    "A billionth of a metre. Used as the name of a chip generation — smaller means newer and denser.",
    "A human hair is roughly 80,000 nm across. Rapidus is trying to jump from 40 nm straight to 2 nm, skipping the steps in between."],

  /* ---- policy ---- */
  "industrial-policy": ["Industrial policy",
    "A government deliberately trying to build up particular industries, rather than leaving it to the market.",
    "Cheap loans, tax breaks, tariffs, subsidies, research money, or simply telling firms what it wants. Whether it works is the argument this lesson is about."],
  miti: ["MITI",
    "Japan's Ministry of International Trade and Industry, 1949–2001. Reorganised into METI.",
    "For forty years it decided who could import technology, who got foreign currency and who got cheap loans. Its reputation, at home and abroad, was enormous."],
  "developmental-state": ["Developmental state",
    "Chalmers Johnson's term for a country whose government treats economic growth as its first job, and uses the market as a tool for it.",
    "He contrasted it with the “regulatory state”, which only sets the rules and referees. His 1982 book made MITI famous outside Japan."],
  "administrative-guidance": ["Administrative guidance (gyōsei shidō)",
    "A ministry telling a company what to do without any law requiring it to obey.",
    "It worked because the ministry controlled things firms needed — currency, licences, loans. Hard to appeal against something that was never written down."],
  "national-champion": ["National champion",
    "One company a government picks to carry a whole country's hopes in an industry, and then supports.",
    "Elpida was Japan's in memory chips. It received about ¥140 billion of state support in 2009 and went bankrupt 34 months later."],
  keiretsu: ["Keiretsu",
    "A cluster of Japanese companies that own shares in one another and bank together.",
    "It made firms hard to take over and long-term in outlook — and slow to abandon a losing business."],
  subsidy: ["Subsidy",
    "Public money given to a company or industry to make something happen that otherwise would not.",
    "Japan allocated about ¥3.9 trillion to semiconductors between 2021 and 2023 — 0.71% of its GDP, a bigger share than the United States, Germany or France spent."],
  incj: ["INCJ",
    "The Innovation Network Corporation of Japan, a state-backed investment fund, 2009–2024.",
    "It invested ¥1.30 trillion across 144 projects and got ¥2.33 trillion back. But <strong>one</strong> of those 144 — Renesas — produced ¥1.25 trillion of the profit. Take it out and the fund loses money."],
  rapidus: ["Rapidus",
    "A Japanese chip company founded in 2022 to make 2-nanometre processors in Hokkaido.",
    "About ¥2.35 trillion of government money committed so far, against roughly ¥0.27 trillion from private investors. It has prototypes and, as of mid-2026, no announced customer."],

  /* ---- thinking about evidence ---- */
  correlation: ["Correlation",
    "Two things moving together. It does not tell you which one caused the other, or whether anything did.",
    "Government help and slow growth go together in Japan's record. That could mean help causes slowness — or that governments help industries <em>because</em> they are already slow."],
  causation: ["Causation",
    "One thing actually making another happen, as opposed to merely accompanying it.",
    "Almost impossible to prove from history alone, because you cannot re-run the 1960s with the policy switched off."],
  "selection-effect": ["Selection effect",
    "When the way things got into your sample is itself the thing distorting the answer.",
    "Hospitals are full of sick people. That is not evidence that hospitals make you ill — and it is exactly the trap in judging industrial policy by which industries got the money."],
  "r-and-d": ["R&D",
    "Research and development — the money a country or company spends working out how to make new things.",
    "As a share of the economy: South Korea 4.94%, the USA 3.45%, Japan 3.44%, Germany 3.15%, China 2.58% (2023)."],
  ifr: ["IFR",
    "The International Federation of Robotics, which counts the world's industrial robots every year.",
    "Almost every robot statistic anyone quotes traces back to its World Robotics report."],
  oica: ["OICA",
    "The international organisation of motor vehicle manufacturers, which publishes how many cars each country built.",
    "The standard source for production league tables. 96.4 million vehicles were built worldwide in 2025."],
};
